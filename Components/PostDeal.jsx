...
const PostDeal = ({ session }) => {
  ...
  // useEffect(() => {
  //   if (session) setAuthor(session?.user.id);
  // }, [session]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error) {
        console.error("Error posting deal:", error, "supabase error");
  ...
  return (
    <View style={styles.formContainer}>
      ...
      />
      {/* <ImageViewer
        placeholderImageSource={placeholderImageViewerImage}
